...
public class PlayerController2D : MonoBehaviour
{
    ...
    private void RaycastForCollisions()
    {
        ...
        _isCollidingUpMain = Physics.Raycast(RelativeCenter, Vector3.up, out _upColHit, _characterBounds.extents.y + _collisionMainRayLength, _nonPlayerLayers);
        _isCollidingDownMain = Physics.Raycast(RelativeCenter, Vector3.down, out _downColHit, _characterBounds.extents.y + _collisionMainRayLength, _walkableGround);
        _isCollidingLeftMain = Physics.Raycast(RelativeCenter, Vector3.left, out _leftColHit, _characterBounds.extents.x + _collisionMainRayLength, _nonPlayerLayers);
        _isCollidingRightMain = Physics.Raycast(RelativeCenter, Vector3.right, out _rightColHit, _characterBounds.extents.x + _collisionMainRayLength, _nonPlayerLayers);
        ...
        _isCollidingUpLeft = Physics.Raycast(UpperLeftRay, out _upLeftColHit, _characterBounds.extents.y + _collisionRayLength, _nonPlayerLayers);
        _isCollidingUpRight = Physics.Raycast(UpperRightRay, out _upRightColHit, _characterBounds.extents.y + _collisionRayLength, _nonPlayerLayers);
        _isCollidingDownLeft = Physics.Raycast(LowerLeftRay, out _downLeftColHit, _characterBounds.extents.y + _collisionRayLength, _nonPlayerLayers);
        _isCollidingDownRight = Physics.Raycast(LowerRightRay, out _downRightColHit, _characterBounds.extents.y + _collisionRayLength, _nonPlayerLayers);

        _isCollidingLeftUpper = Physics.Raycast(LeftUpperRay, out _leftUpperColHit, _characterBounds.extents.x + _collisionRayLength, _nonPlayerLayers);
        _isCollidingRightUpper = Physics.Raycast(RightUpperRay, out _rightUpperColHit, _characterBounds.extents.x + _collisionRayLength, _nonPlayerLayers);
        _isCollidingLeftLower = Physics.Raycast(LeftLowerRay, out _leftLowerColHit, _characterBounds.extents.x + _collisionRayLength, _nonPlayerLayers);
        _isCollidingRightLower = Physics.Raycast(RightLowerRay, out _rightLowerColHit, _characterBounds.extents.x + _collisionRayLength, _nonPlayerLayers);
        #endregion
    }
